...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("astrixsete/"..tostring(game.GameId)) do
...
function library:deleteConfig()
    if isfile("astrixsete/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg") then
        delfile("astrixsete/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
